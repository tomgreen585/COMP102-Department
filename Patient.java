...
public class Patient implements Comparable<Patient>{
    ...
    public int getLastTreatmentTime(){return lastTreatmentTime;}
    public int getLastWaitTime(){return lastWaitTime;}
    ...
    public int compareTo(Patient other){
        ...
        {
            //Compare arrival time if priorities are equal
            if(getArrivalTime() < other.getArrivalTime())
                return 1;
            else if(getArrivalTime() == other.getArrivalTime())
                return 0;
            else
                return -1;
        }
    ...
    public void makeRandomTreatments(){
        ...
        for (int i=0; i<n; i++){
            ...
            else if(num < 0.57)
            {
                ...
                treatmentTimes.add(randomTreatmentTime(100));
            }
            else {
                treatments.add("ER beds");
                treatmentTimes.add(randomTreatmentTime(10));
